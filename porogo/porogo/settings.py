"""
Django settings for porogo project.
...
WSGI_APPLICATION = 'porogo.wsgi.application'
...
MEDIA_URL = 'media/'
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), 'porogo')
