...
github_link = models.ManyToMany(URL)
...
URL is a model that simply holds a url to enable one to many relationships.

```py
id: Implicitely generated by django PK
...
Stores images with their hover and alt text.
